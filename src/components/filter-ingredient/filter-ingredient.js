            ...
            <div className='ingredFilt-container'>
                <div className='left'>
                    ...
                    <form>
                        ...
                        <button className='add-more-ingred' type='button' onClick={this.context.addIngredField}>+ add more ingredient</button>
                        <button className='search' onClick={(e) => this.context.handleIngredFiltSubmit(e)}>search</button>
